...
const double PhotoDisintegration::epsMin = log10(2. * eV)+3; // log10 minimum photon background energy in nucleus rest frame
const double PhotoDisintegration::epsMax = log10(2. * eV)+8.12; // log10 maximum photon background energy in nucleus rest frame
